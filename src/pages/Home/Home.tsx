    ...
    <div className="min-h-screen bg-gray-950 text-white font-sans selection:bg-blue-500/30">
      ...
      <nav className="flex items-center justify-between px-6 py-6 md:px-12 border-b border-gray-900 bg-gray-950/50 backdrop-blur-md sticky top-0 z-50">
        <div className="flex items-center gap-2">
          <div className="bg-blue-600 h-8 w-8 rounded-lg flex items-center justify-center font-bold">D</div>
        ...
        <div className="flex items-center gap-4">
          <Link to="/login" className="text-sm font-medium hover:text-blue-400 transition">Entrar</Link>
          <Link 
            to="/dashboard" 
      ...
      <section className="relative pt-20 pb-32 px-6 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
            ...
            estoque e clientes em tempo real, com design focado em alta performance.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/dashboard" className="px-8 py-4 bg-white text-black rounded-xl font-bold text-lg hover:bg-gray-200 transition">
