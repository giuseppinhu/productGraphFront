    ...
    <div className="p-8 bg-gray-950 min-h-screen text-gray-100 w-screen">
      <div className="flex flex-col md:flex-row justify-between md:items-center mb-8 gap-4">
        <div>
          ...
          <p className="text-gray-400">
            Painel para gerenciar os usuários
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-gray-900/50 border border-gray-800 p-6 rounded-2xl">
          ...
          <h3 className="text-3xl font-bold mt-1">{data.data.totalNew}</h3>
        </div>
        <div className="bg-gray-900/50 border border-gray-800 p-6 rounded-2xl">
        ...
        <div className="bg-gray-900/50 border border-gray-800 p-6 rounded-2xl">
          <p className="text-gray-500 text-sm font-medium">Usuários Permitidos</p>
