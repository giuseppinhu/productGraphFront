...
import SaleModal from "../../components/Modals/SalesModal/SalesModal";
...
const Sales = () => {
  ...
  }, [page, searchTerm, status, modalOpen]);
    ...
    <div className="p-10 bg-gray-950 text-white w-full min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-gray-900 p-5 rounded-xl border border-gray-800">
          ...
          <h3 className="text-2xl font-bold">{data.budges.quantity || 0}</h3>
        </div>
        <div className="bg-gray-900 p-5 rounded-xl border border-gray-800">
