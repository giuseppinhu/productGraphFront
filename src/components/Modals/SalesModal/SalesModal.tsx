    ...
    >
      <div className="bg-gray-950 border border-gray-800 w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                className={
                  "p-3 bg-gray-900/50 rounded-xl border border-gray-800 text-gray-300"
                }
              />
            </div>
        ...
        <div className="p-6 border-t border-gray-900 bg-gray-900/20 flex gap-3">
          <button
            onClick={onClose}
            className="flex-1 bg-gray-900 text-gray-400 py-3 rounded-xl hover:bg-gray-800 transition-all"
          >
            Fechar
          </button>
        </div>
